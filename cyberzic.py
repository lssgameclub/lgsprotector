...
vipro = LINETCR.LINE()
#vipro.login(qr=True)
vipro.login(token='cfAbWdF9FH7dk99J446CZ+H9IuJxKMnF9ueah/KA81X/+pTPiALdPTxH4GbG89slJEQPurXk85ri/fj7exNM3NN8JX56NlqbU2eHniR+i9/bhmBP41HYuzoUDHBVRNU6zPnaZqvhrUd7tDbbxuL2twdB04t89/1O/w1cDnyilFU=')
vipro.loginResult()
print "Cyber-Login Success\n\n=====[Sukses Login]====="
...
╚══════════════════
"""
vip="U058189b5f1405e4069ebe230a511c9fe"
...
Bots=[mid]
Creator=["u3a69176595789fac1792207c0affbd43"]
admin=["u3a69176595789fac1792207c0affbd43"]
...
wait = {
    ...
    'timeline':True,
    "Timeline":True,
    "comment":"Bot Auto Like ©By : I💉  ⛓️LGS⛓️💉",    
    "commentOn":False,
    "commentBlack":{},
    "message":"Thx For Adding Me (^_^)\nInvite Me To Your Group ヘ(^_^)ヘ",    
    "blacklist":{},
    "wblacklist":False,
    "dblacklist":False,
    "Qr":False,
...
def upload_tempimage(client):
     '''
         Upload a picture of a kitten. We don't ship one, so get creative please!
     '''
     config = {
         'album': album,
